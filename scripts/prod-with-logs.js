...
const startupMessage = 'Starting Next.js production server with logging enabled';
...
console.log(
  '\n' +
    ...
    `${colors.bold}${colors.green}║${colors.reset} ${colors.cyan}Next.js Production Server${colors.reset}                          ${colors.bold}${colors.green}║${colors.reset}\n` +
...
nextStart.on('exit', code => {
  const exitMessage = `Next.js production server exited with code ${code}`;
